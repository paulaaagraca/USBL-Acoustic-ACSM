...
Fx = 15000;  % USE THIS FOR THE LAB CLASS on Tuesday, 14h
...
NbitsHF = 8;    % Number of bits to quantize the fractional part of the coefs.
...
% bandpass equiripople FIR filter, attn=50 dB, passband = ( 14k - 16k ), 
%                                              stopband = <10k, >20k
...
% Quantize to 10 fracional bits (9 integer bits are required to represent
% phase differences in the range [-180, +180] degrees.
Phase = round( Phase * 2^10 ) / 2^10;
