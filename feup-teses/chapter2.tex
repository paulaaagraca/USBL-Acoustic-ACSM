...
\note{dúvida - relatively low sound speed propagation ??}
%In acoustic underwater environment this is aggravated by the relatively low sound speed propagation, which makes relevant the Doppler effect due to the relative movement of the systems [AUVs?]
...
\begin{table}[!htbp] %use !htbp to adjust
	...
	\begin{tabular}{l|l l l l l l}
		\toprule
		\textbf{Company} & \textbf{System} & \textbf{Bandwidth(kHz)} &\textbf{Connection(kbps)} & \textbf{Range(m)} & Precision() & Update frequency \\ 
		\midrule
