...
add wave -noupdate -divider CORDIC
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/re1
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/im1
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/phase1
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/re2
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/im2
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/phase2
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/re3
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/im3
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/phase3
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/re4
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/im4
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/phase4
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/start_cordic
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/x
add wave -noupdate -radix decimal /tb_all_phase/uut1/cordic_uut/y
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {40649120 ps} 0}
...
update
WaveRestoreZoom {40480707 ps} {41409499 ps}
