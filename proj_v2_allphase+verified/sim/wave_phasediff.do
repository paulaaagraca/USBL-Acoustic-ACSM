...
add wave -noupdate -divider CORDIC
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/re1
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/im1
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/phase1
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/re2
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/im2
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/phase2
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/re3
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/im3
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/phase3
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/re4
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/im4
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/phase4
add wave -noupdate -group CORDIC /tb_all_phase/uut1/cordic_uut/sel_in
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/start_cordic
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/x
add wave -noupdate -group CORDIC -radix decimal /tb_all_phase/uut1/cordic_uut/y
add wave -noupdate -divider PHASEDIFF
add wave -noupdate /tb_all_phase/uut1/phasediff_uut/phase1
add wave -noupdate /tb_all_phase/uut1/phasediff_uut/phase2
add wave -noupdate /tb_all_phase/uut1/phasediff_uut/phase3
add wave -noupdate /tb_all_phase/uut1/phasediff_uut/phase4
add wave -noupdate /tb_all_phase/uut1/phasediff_uut/angle1
add wave -noupdate /tb_all_phase/uut1/phasediff_uut/angle2
add wave -noupdate /tb_all_phase/uut1/phasediff_uut/angle3
add wave -noupdate /tb_all_phase/uut1/phasediff_uut/angle4
add wave -noupdate /tb_all_phase/uut1/phasediff_uut/angle5
add wave -noupdate /tb_all_phase/uut1/phasediff_uut/angle6
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {35997429 ps} 0}
...
update
WaveRestoreZoom {33544853 ps} {48405525 ps}
