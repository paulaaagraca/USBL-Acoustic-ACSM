...
reg signed [12:0]  rXimaguw; 
reg signed [12:0]  rXimagdw; 
reg signed [12:0]  rYimaguw; 
reg signed [12:0]  rYimagdw; 
...
phasediff phasediff_y(
    ...
    .reset(reset),  
	 .data_rdy(endata),
    .in_phase1(rXphaseuw),	// 9Q10
    .in_phase2(rXphasedw),	// 9Q10
...
phasediff phasediff_x(
    ...
    .reset(reset),  
	 .data_rdy(endata),
    .in_phase1(rYphaseuw),	// 9Q10
    .in_phase2(rYphasedw),	// 9Q10
